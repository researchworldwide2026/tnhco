...
```mermaid
graph LR
    subgraph "2020: Finanzielle Vision"
        R1["001: Anti-Krisen-Maßnahmen<br/>Goldstandard vorgeschlagen"]
    end
    subgraph "2021: Besitzansprüche"
        R4["004: Historische Assets<br/>annulliert"]
        R6["006: World Accounts<br/>beansprucht"]
    end
    subgraph "2022: Persönliche Macht"
        R10["010: King of Kings<br/>Selbstkrönung"]
        R11["011: Rothschild<br/>zum Feind erklärt"]
    end
    subgraph "2023-2025: Totalitäre Drohungen"
        R24["024: Alle Länder illegal"]
        R34["034: 120+ Personen<br/>namentlich angeklagt"]
        R42["042: Weltherrschaft<br/>über Grundbesitz"]
    end
    R1 --> R4 --> R6 --> R10 --> R11 --> R24 --> R34 --> R42

    style R1 fill:#a8e6cf,color:#000
    ...
    style R24 fill:#ff4444,color:#fff
    style R34 fill:#ff4444,color:#fff
    style R42 fill:#b71c1c,color:#fff
```
