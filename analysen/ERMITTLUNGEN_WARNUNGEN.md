...
graph TB
    ...
    subgraph "Medienberichte"
        NEWS24["News24: 'Hawks conclude<br/>case, unsubstantiated'"]
        TIMESLIVE["TimesLIVE: 'No substance<br/>to Sexwale complaint'"]
        SABC["SABC: 'Sexwale might have<br/>fallen victim to scammers'"]
        CITIZEN["The Citizen: 'Claims<br/>unsubstantiated'"]
        DAILYSUN["Daily Sun: 'Amabillion<br/>claims squashed'"]
        THESOUTHAFRICAN["The South African:<br/>'White Spiritual Boy Bust'"]
        SEKTY_CZ["sekty.tv: Paramonov<br/>Investigativer Bericht"]
        FARMERS_SA["Farmers Lives Matter SA:<br/>Money Laundering Exposé"]
    end

    subgraph "Betroffene"
        SEXWALE["👤 Tokyo Sexwale<br/>Anzeigeerstatter"]
        PARAMONOV["👤 Alexander Paramonov<br/>M1 Chief Treasurer"]
        TNHCO["🏛️ TNHCO<br/>Dokumenten-Host"]
    end

    HAWKS -->|"Ermittelt für"| SEXWALE
    HAWKS -->|"Ermittlungen betrafen"| PARAMONOV
    SARB -->|"Warnt vor"| PARAMONOV
    CNB -->|"Warnt vor"| PARAMONOV
    
    NEWS24 -->|"Berichtet über"| HAWKS
    TIMESLIVE -->|"Berichtet über"| HAWKS
    SABC -->|"Berichtet über"| SEXWALE
    CITIZEN -->|"Berichtet über"| HAWKS
    DAILYSUN -->|"Berichtet über"| HAWKS
    THESOUTHAFRICAN -->|"Berichtet über"| HAWKS
    SEKTY_CZ -->|"Berichtet über"| PARAMONOV
    FARMERS_SA -->|"Berichtet über"| PARAMONOV

    PARAMONOV -->|"Dokumentiert durch"| TNHCO

    style HAWKS fill:#6c5ce7,color:#fff
    style SARB fill:#e17055,color:#fff
    style CNB fill:#e17055,color:#fff
